...
extension HydrationLogQueryWhereSort
  ...
  QueryBuilder<HydrationLog, HydrationLog, QAfterWhere> anyTimestamp() {
    return QueryBuilder.apply(this, (query) {
...
extension HydrationLogQueryWhere
  ...
  QueryBuilder<HydrationLog, HydrationLog, QAfterWhereClause> timestampEqualTo(
      DateTime timestamp) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<HydrationLog, HydrationLog, QAfterWhereClause> timestampLessThan(
    DateTime timestamp, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<HydrationLog, HydrationLog, QAfterWhereClause> timestampBetween(
